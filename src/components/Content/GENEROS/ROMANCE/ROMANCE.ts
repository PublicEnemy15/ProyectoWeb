...
export class ROMANCESlider {
    ...
    private resizeButtonsToImageContainer(): void {
        ...
        const prevWrapper = document.querySelector('.romance-slider .KITHSlider-btnWrapper.prev') as HTMLElement;
        const nextWrapper = document.querySelector('.romance-slider .KITHSlider-btnWrapper.next') as HTMLElement;
