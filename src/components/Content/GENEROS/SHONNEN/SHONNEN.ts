...
export class SHONNENSlider {
    ...
    constructor(config: SliderConfig) {
        ...
        this.slider = document.querySelector('.shonnen-slider .Slider-tape');
        this.sliderWrapper = document.querySelector('.shonnen-slider .KITHSlider-sliderWrapper');
        const allItems = document.querySelectorAll<HTMLElement>('.shonnen-slider .Slider-item');
        this.items = Array.from(allItems);
        this.totalItems = this.items.length;
        this.totalPages = Math.ceil(this.totalItems / this.itemsPerPage);
        
        this.nextBtn = document.querySelector('.shonnen-slider .KITHSlider-btnWrapper.next button');
        this.prevBtn = document.querySelector('.shonnen-slider .KITHSlider-btnWrapper.prev button');
        this.nextWrapper = document.querySelector('.shonnen-slider .KITHSlider-btnWrapper.next');
        this.prevWrapper = document.querySelector('.shonnen-slider .KITHSlider-btnWrapper.prev');
        this.bulletsContainer = document.querySelector('.shonnen-slider .KITHSlider-bullets');
