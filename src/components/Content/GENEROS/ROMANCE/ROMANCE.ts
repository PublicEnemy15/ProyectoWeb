...
export class ROMANCESlider {
    ...
    constructor(config: SliderConfig) {
        ...
        this.slider = document.querySelector('.romance-slider .Slider-tape');
        this.sliderWrapper = document.querySelector('.romance-slider .KITHSlider-sliderWrapper');
        const allItems = document.querySelectorAll<HTMLElement>('.romance-slider .Slider-item');
        this.items = Array.from(allItems);
        this.totalItems = this.items.length;
        this.totalPages = Math.ceil(this.totalItems / this.itemsPerPage);
        
        this.nextBtn = document.querySelector('.romance-slider .KITHSlider-btnWrapper.next button');
        this.prevBtn = document.querySelector('.romance-slider .KITHSlider-btnWrapper.prev button');
        this.nextWrapper = document.querySelector('.romance-slider .KITHSlider-btnWrapper.next');
        this.prevWrapper = document.querySelector('.romance-slider .KITHSlider-btnWrapper.prev');
        this.bulletsContainer = document.querySelector('.romance-slider .KITHSlider-bullets');
