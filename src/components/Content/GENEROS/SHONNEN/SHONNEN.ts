...
export class SHONNENSlider {
    ...
    private resizeButtonsToImageContainer(): void {
        ...
        const prevWrapper = document.querySelector('.shonnen-slider .KITHSlider-btnWrapper.prev') as HTMLElement;
        const nextWrapper = document.querySelector('.shonnen-slider .KITHSlider-btnWrapper.next') as HTMLElement;
