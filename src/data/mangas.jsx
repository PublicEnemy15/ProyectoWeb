export const seriesData = [
  //SLIDER Y DESTACADAS a
  {
    slug: 'gokurakugai',
    title: 'Gokurakugai',
    author: 'Jigokuraku',
    description: 'Gokurakugai, un luminoso y bullicioso barrio obrero con un lado oscuro oculto. En esta zona sin orden, Tao y Alma trabajan como buscadores de problemas a sueldo. Sus misiones consisten en ayudar a un joven a encontrar a su amigo perdido, a una persona que desaparece sin dejar rastro y a cadáveres de animales desfigurados. Mientras tanto, los espíritus malignos que viven en las sombras sacan a relucir una faceta diferente de estos buscadores de problemas.',
    portada: {
    ...
    tags: ['Acción', 'Sobrenatural', 'Crimen', 'Drama'],
    volumes: [
      {
        title: 'Volumen 1',
...

  {
    ...
    portada: {
      desktop: '/imagen/goldenkamuy/2.webp',
...

  {
    ...
    portada: {
      desktop: '/imagen/hotel/1.webp',
      mobile: '/imagen/hotel/1.webp',
    },
    pg: '192 páginas',
    enlace: '#',
    edadr: '+18',
    status: 'Finalizado',
    recursos: [],
    tags: ['Comedia negra', 'Surrealismo', 'Misterio'],
    volumes: []
  },
  {
    ...
    portada: {
      desktop: '/imagen/karakuri/1.webp',
      mobile: '/imagen/karakuri/1.webp',
    },
    pg: '208 páginas',
    enlace: '#',
    edadr: '+16',
  ...
  },
  {
    ...
    portada: {
      desktop: '/imagen/owarimonogatari/2.webp',
      mobile: '/imagen/owarimonogatari/2.webp',
    },
    pg: '232 páginas',
    enlace: '#',
    edadr: '+16',
    status: 'Finalizado',
    recursos: [],
    tags: ['Psicológico', 'Misterio', 'Sobrenatural'],
    volumes: []
  },
  {
    ...
    portada: {
      desktop: '/imagen/jibaku/1.webp',
      mobile: '/imagen/jibaku/1.webp',
    },
    pg: '176 páginas',
    enlace: '#',
    edadr: '+13',
    status: 'En curso',
    recursos: [],
    tags: ['Sobrenatural', 'Escolar', 'Comedia', 'Misterio'],
    volumes: []
  },
  {
    slug: 'out',
    ...
    portada: {
      desktop: '/imagen/out/2.webp',
      mobile: '/imagen/out/2.webp',
    },
    pg: '208 páginas',
    enlace: '#',
    edadr: '+18',
    status: 'En curso',
    recursos: [],
    tags: ['Delincuencia', 'Seinen', 'Drama', 'Acción'],
    volumes: []
  },
  {
    slug: 'choujin-x',
    ...
    portada: {
      desktop: '/imagen/choujinx/1.webp',
      mobile: '/imagen/choujinx/1.webp',
    },
    pg: '224 páginas',
    ...
    tags: ['Acción', 'Sobrenatural', 'Drama', 'Fantasía oscura'],
    volumes: []
  },
  {
    slug: 'sakamoto-days',
    ...
    portada: {
      desktop: '/imagen/sakamoto/1.webp',
      mobile: '/imagen/sakamoto/1.webp',
    },
    pg: '192 páginas',
    ...
    tags: ['Acción', 'Comedia', 'Shounen'],
    volumes: []
  },
  {
    slug: 'youkoso-futsuu-no-gakuen-e',
    title: 'Youkoso Futsuu no Gakuen e!',
    author: 'Kei Azumi',
    ...
    portada: {
      desktop: '/imagen/youkoso/2.webp',
      mobile: '/imagen/youkoso/2.webp',
    },
    pg: '190 páginas',
    enlace: '#',
    edadr: '+13',
    status: 'En curso',
    recursos: [],
    tags: ['Comedia', 'Escolar', 'Parodia', 'Shounen'],
    volumes: []
  }
