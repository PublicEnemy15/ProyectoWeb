...
export class SEINENSlider {
    ...
    constructor(config: SliderConfig) {
        ...
        this.sliderWrapper = document.querySelector('.seinen-slider .KITHSlider-sliderWrapper');
        ...
        this.nextWrapper = document.querySelector('.seinen-slider .KITHSlider-btnWrapper.next');
        this.prevWrapper = document.querySelector('.seinen-slider .KITHSlider-btnWrapper.prev');
